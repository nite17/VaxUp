        ...
        <div className="dash ml-100 -mt-6">
            <div className="Head">
                ...
                <div className="options">
                    <button className="notif"><img src={bell_icon} /></button>
            ...
            <div className="main-info">
                <div className="upcoming">
                    ...
                    <div className="upcoming-info">
                        ...
                        <button className="main-info-buttons"><img src={directions} /> Get Directions</button>
                    </div>
                </div>
                <div className="totalVax">
                    ...
                    <div className="totalvax-info">
                        <h1><CountUp end={patient?.totalVaccinations} /></h1>
                    </div>
                </div>
                <div className="pendingVax">
                    ...
                    <div className="pending-info">
                        ...
                        <button className="main-info-buttons"><img src={scheduleNow} /> Schedule Now</button>
                    </div>
                </div>
            </div>
