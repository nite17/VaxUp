  ...
  <path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5M2 2a1 1 0 0 0-1 1v1h14V3a1 1 0 0 0-1-1zm13 3H1v9a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1z"/>
            ...
            <div class="flex justify-between ">
                <div class="flex flex-col ml-6">
                    <p class="text-2xl text-black font-extralight">Sunday, March 31</p>
                    <p class="text-4xl text-black font-extralight -mt-4">09:00 AM</p>
                </div>
                <div class="flex flex-col mr-20">
                    <p class="text-2xl text-black font-extralight">Location: Apollo Hospital, Chennai</p>
            ...
            <div class="bg-gradient-to-r from-white to-appinto w-full rounded-2xl h-[116px] flex justify-between" >
                <div class="flex flex-col  mt-1">
                    ...
                    <p class="text-4xl text-black font-extralight -mt-4 ml-6">Dr. Emily Carter</p>
                </div>
